...
public class CityFragment extends Fragment implements ConnectionCallbacks,OnConnectionFailedListener{
    ...
    public void onActivityResult(int requestCode, int resultCode, android.content.Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == android.app.Activity.RESULT_OK) {
                ...
                String url = "http://" + com.project.sagar.loctrack.Common.IP + "/LocTrackWeb/addyesloc.php";
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) rootView.findViewById(com.project.sagar.loctrack.R.id.yes_view);
        mAdapter = new MyAdapterYes(myDataset);
        ...
        SwipeDismissRecyclerViewTouchListener listener = new SwipeDismissRecyclerViewTouchListener.Builder(
                ...
                new SwipeDismissRecyclerViewTouchListener.DismissCallbacks() {
                    ...
                    public void onDismiss(View view) {
                        ...
                        builder.setMessage("Are you sure you want to delete the GREEN place?");
        ...
        String url = "http://" + com.project.sagar.loctrack.Common.IP + "/LocTrackWeb/getyesloc.php";
